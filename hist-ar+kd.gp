...
## filledcurves work-around for kdensity: https://sourceforge.net/p/gnuplot/mailman/message/35195264/
set table $SMOOTHED
plot datafile u col:(1. / STATS_records) smooth kdensity bandwidth sigma ti ''
unset table
